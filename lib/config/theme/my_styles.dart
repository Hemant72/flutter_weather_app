...
import 'package:flutter_weather_app/config/theme/dark_theme_colors.dart';
import 'package:flutter_weather_app/config/theme/light_theme_colors.dart';
import 'package:flutter_weather_app/config/theme/my_fonts.dart';
import 'package:flutter_weather_app/config/theme/theme_extensions/shimmer_theme_data.dart';

class MyStyles {
  /// custom header theme
  static ShimmerThemeData getShimmerTheme({required bool isLightTheme}) =>
      ShimmerThemeData(
